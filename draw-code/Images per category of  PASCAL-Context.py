...
# @Time   : 2020/11/12
# @Author :
# @File   : Images per category of  PASCAL-Context.py
# @description    ：Use bar charts to represent the number of images per category of PASCAL-Context
...
def main():
    ...
    file_path = os.path.join(root, r'DrawingData\Images per category of PASCAL-Context(59classes).csv')
    save_path = os.path.join(root, r'Pictures\Images per category of PASCAL-Context.jpg')
    ...
    plt.bar(x, y1, 0.8,   label='PASCAL-Context', color='cornflowerblue')
