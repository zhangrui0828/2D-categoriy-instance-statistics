...
# @Time   : 2020/11/12
# @Author :
# @File   : Images per category of  SIFT-flow.py
# @description    ：Use bar charts to represent the number of images per category of SIFT-flow
...
def main():
    ...
    file_path = os.path.join(root, r'DrawingData\Images per category of  SIFT-flow.csv')
    save_path = os.path.join(root, r'Pictures\Images per category of SIFT-flow.jpg')
    ...
    plt.bar(x, y1, 0.8,   label='SIFT-flow', color='purple')
