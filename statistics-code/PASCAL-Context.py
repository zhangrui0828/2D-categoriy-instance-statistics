...
# @Time   : 2020/11/12
# @Author :
# @File   : PASCAL-Context.py
# @description  ：This code statistics information about PASCAL-Context datasets
...
def main():
    root = r"\Dataset\trainval\trainval"  # modify to your own path

    image_list = get_files(root)

    images_perclass = [0 for i in range(468)]
    classes_per = [0 for i in range(468)]

    for image in tqdm(image_list):
        m = loadmat(image)
        #print(m['LabelMap'])
        m_list = m['LabelMap'].flatten()
